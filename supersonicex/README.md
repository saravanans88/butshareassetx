...
This is a light wallet that connects to a Assetex API provided by the *witness_node* executable.
...
Assetex-UI depends node Node.js, and version 6+ is required.
...
## Testnet
By default Assetex-ui connects to the live Assetex network, but it's very easy to switch it to the testnet run by Xeroc. To do so, open the UI in a browser, go to Settings, then under Access, select the *Public Testnet Server* in the dropdown menu. You should also change the faucet if you need to create an account, the testnet faucet address is https://testnet.Assetex.eu.
...
The Assetex UI team is supported by this [worker proposal](http://www.Assetex.foundation/workers/2017-08-bill-butler). It provides the funds needed to pay the coordinator and the bounties and the Assetex Foundation.

If you would like to get involved, we have a [Telegram chatroom](https://t.me/AssetexDEX) where you can ask questions and get help. You may also join [Assetex on Discord](https://discord.gg/GsjQfAJ)
