...
export default class ExchangeHeader extends React.Component {
    ...
    render() {
        ...
        return (
           <div className="exchange-header-padding">
            <div className="grid-block shrink no-padding overflow-visible exchange-header-padding-width">
                <div className="grid-block overflow-visible">
                    <div className="grid-block shrink exchange-left-box">
