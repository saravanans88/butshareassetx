    ...
    render() {
        ...
        return (
            <div className="grid-block vertical">
                ...
                />
                <div className="grid-block_sp page-layout market-layout">
                    ...
                    <div
                        style={{paddingTop: 0}}
                        className={cnames(
                            "grid-block main-content vertical no-overflow exchange-main-content"
                        )}
                    >
                        <div
                        ...
                        >
                            {!showDepthChart ? (
                                <div
                                    className="grid-block shrink no-overflow exchange-chart-bottom"
                                    id="market-charts"
                                >
                                    {/* Price history chart */}
                                    <PriceChartD3
                    ...
                    <div className="grid-block shrink right-column no-overflow vertical show-for-medium exchange-main-content">
                        {/* Market History */}
